# SIMPLE VIRTUAL ASSISTENT "JARMAX" by MhinProject
...
from ecapture import ecapture as ec     #pip install <>
...
print("Initializing JARMAX...")
speak("Initializing JARMAX")
wishMe()
...
if __name__=='__main__':
    ...
    while True:
        ...
        if "good bye" in statement or "bye" in statement or "stop" in statement or "see you" in statement or "nothing" in statement:
            speak('your personal assistant JARMAX is shutting down, Good bye')
            print('your personal assistant JARMAX is shutting down, Good bye')
            break
        ...
        if 'wikipedia' in statement:
            ...
            songs_dir = "G:/AUDIO/music/Campur"
            ...
            codePath = "Your/Code/Path ect. VSCode ;)"
